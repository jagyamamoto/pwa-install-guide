...
ある町内会アプリで、実機テストと修正を10回以上繰り返して到達した設計をそのまま部品化した。
...
- 実装元: ある町内会アプリの `InstallGuide.tsx`（本番で実際に使われている実装をそのまま部品化）
- 検証: 2026-07-30 〜 2026-08-05・iPhone 17e / iPhone SE 第3世代（シミュレータ）＋ iPhone 15 Pro Max（実機）
...
作者: [Jag Yamamoto](https://www.jagproject.com/about)（屋号: Jag Project）
